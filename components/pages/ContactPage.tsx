  ...
  return (
    <article>
      ...
      <Section variant="content-band" tone="white">
        <Container>
          <SectionIntro label={content.section.label} title={content.section.title} />
          <div className="reveal-group mt-11 grid gap-10 xl:grid-cols-[minmax(16rem,0.36fr)_minmax(0,0.64fr)] xl:gap-16">
