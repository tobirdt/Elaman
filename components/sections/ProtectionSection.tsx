...
export function ProtectionSection() {
  return (
    <Section id="protection" className="relative overflow-hidden">
      <div
          ...
          <div className="relative">
            ...
            <div className="grid gap-4">
              {protectionContent.items.map((item, index) => (
                <article
                  key={item.title}
                  className="relative rounded-lg border border-line bg-white/82 p-6 shadow-[0_18px_70px_rgba(22,24,29,0.05)] transition duration-200 hover:-translate-y-1 hover:border-elaman-red/24"
                >
