...
This document states *intent*. Token values and component rules live in `DESIGN_SYSTEM.md`. Execution order lives in `IMPLEMENTATION_PLAN.md`.
...
| Anchor | Usage |
|--------|--------|
| Original tagline | *Your bridge to trust and security.* / *Ihre Brücke zu Vertrauen und Sicherheit.* |
| Descriptor | *German Security Solutions* / *Deutsche Sicherheitslösungen* |
...
| Pattern | Where | Rule |
|---------|-------|------|
| Sticky scroll + progress | Lifecycle section | Desktop ≥1024px; degrade on mobile |
